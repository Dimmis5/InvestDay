...
const steps_en = [
  { target: "tour-accueil", title: "📊 Home", description: "Find your stats, wallet summary and game rules.", position: "bottom" },
  { target: "tour-wallet", title: "👛 wallet", description: "See your held assets, current value and performance.", position: "bottom" },
  ...
  { target: "tour-portfolio-badge", title: "📁 Portfolios", description: "You can have up to 4 wallet. Click 1, 2, 3 or 4 to switch between them.", position: "bottom" },
  ...
  { target: "tour-wallet-stats", title: "💰 Account Summary", description: "Here you can see the total value of this specific wallet (Cash + Stocks).", position: "bottom" },
  { target: "tour-wallet-actions", title: "➕ Management", description: "Create up to 4 different wallet to test multiple strategies or go straight to markets.", position: "bottom-left" },
